...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateEmployeeInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/handlers.SearchEmpInDepartmentInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/files/upload": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Custom object key/path (optional)",
                        "name": "path",
                        "in": "formData"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.SearchEmpInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateEmpInput"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.SearchEmpInDepartmentInput": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
